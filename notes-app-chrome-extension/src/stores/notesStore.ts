          ...
          set((state) => {
            ...
            const mergedNotes = state.notes
              ...
              .map(currentNote => {
                ...
                if (currentNote.id === activeNoteId) {
                  console.log(`[NotesStore] Preserving active note ${activeNoteId} (not synced)`)
                  return currentNote
                }
            ...
            syncedNotes.forEach(syncedNote => {
              ...
              if (!existsLocally && !localDeletedNoteIdSet.has(syncedNote.id) && syncedNote.id !== activeNoteId) {
