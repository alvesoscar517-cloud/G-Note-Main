...
export function useSwipeGesture({
  ...
  const handlers = useMemo(() => {
    ...
    return {
      onTouchStart: boundHandlers.onPointerDown as unknown as React.TouchEventHandler<HTMLDivElement>,
      onTouchMove: boundHandlers.onPointerMove as unknown as React.TouchEventHandler<HTMLDivElement>,
      onTouchEnd: boundHandlers.onPointerUp as unknown as React.TouchEventHandler<HTMLDivElement>,
      onTouchCancel: boundHandlers.onPointerCancel as unknown as React.TouchEventHandler<HTMLDivElement>,
